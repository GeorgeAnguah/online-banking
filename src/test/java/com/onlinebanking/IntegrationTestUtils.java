...
public abstract class IntegrationTestUtils {
     ...
     */
    protected UserDto createUser(UserService userService, String username, boolean enabled) {
        return createUser(userService, username, false, enabled);
    }
     ...
     * @return persisted user
     */
    protected UserDto createUser(UserService userService, String username, boolean isAdmin, boolean enabled) {
     ...
     * @return persisted user
     */
    protected UserDto createUser(UserService userService, UserDto userDto) {
        UserDto persistUser = persistUser(userService, false, userDto.isEnabled(), userDto);
