...
class UserServiceIntegrationTest extends IntegrationTestUtils {
    ...
    void createUserWithSpecifiedRoles(TestInfo testInfo) {
        Assertions.assertDoesNotThrow(() -> createUser(userService, testInfo.getDisplayName(), true, false));
    }
    ...
    void createUserAlreadyExistingAndNotEnabled(TestInfo testInfo) {
        UserDto userDto = createUser(userService, testInfo.getDisplayName(), false);
        UserDto existingUser = createUser(userService, userDto);
    ...
    void createUserAlreadyExistingAndEnabled(TestInfo testInfo) {
        UserDto userDto = createUser(userService, testInfo.getDisplayName(), true);
