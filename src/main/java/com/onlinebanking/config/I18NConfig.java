...
public class I18NConfig implements WebMvcConfigurer {
    ...
    /**
     * Setup localChangeInterceptor. The LocalChangeInterceptor bean that will
    ...
    /**
     * Add localChangeInterceptor to registry interceptors. The
     * LocalChangeInterceptor needs to be added to the application’s
