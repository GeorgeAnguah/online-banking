...
public interface CookieService {
    ...
    /**
     * creates a cookie with the specified token and tokenType with duration then adds it to the headers.
     *
     ...
     * @param duration  the duration till expiration
     */
    void addCookieToHeaders(HttpHeaders httpHeaders, TokenType tokenType, String token, Duration duration);
}
